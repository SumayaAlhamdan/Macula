...
const Eviewcourse = () => {
  ...
  return (
    <div className="educator-home">
      ...
      {/* <BlackButton className="submit-button" onClick={() => setButtonPopup(true)} text="Create course" /> */}
      <div style={{ marginLeft: '855px', marginTop: '14px' }}>
  <BlackButton onClick={() => setButtonPopup(true)} text="Create course" />
</div>
